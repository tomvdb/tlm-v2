...
namespace tlm_v2
{
    public class ImGuiRenderer
    {
        ...
        public unsafe ImGuiRenderer(Game game)
        {
            ...
            {
            FontAwesome6.IconMin, FontAwesome6.IconMax, 0
            }, GCHandleType.Pinned);
            

            ImFontConfigPtr iconCfg = ImGuiNative.ImFontConfig_ImFontConfig();
            iconCfg.MergeMode = true;
            iconCfg.PixelSnapH = true;

            // setup custom font
            var myfont = io.Fonts.AddFontFromFileTTF("Roboto-Regular.ttf", 18f);
            GlobalFonts.awesomeFont = io.Fonts.AddFontFromFileTTF("fa-solid-900.ttf", 14f, iconCfg, rangeHandle.AddrOfPinnedObject());
            io.Fonts.AddFontFromFileTTF("fa-regular-400.ttf", 14f, iconCfg, rangeHandle.AddrOfPinnedObject());
            GlobalFonts.fixedFont = io.Fonts.AddFontFromFileTTF("fixedsys.ttf", 18f);
